...
import { Brain, Mail, Lock, ArrowRight, Loader2, Sparkles, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex bg-background font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 overflow-hidden bg-primary">
        ...
        <div className="relative z-10">
          <Link href="/" className="flex items-center gap-3 w-fit transition-transform hover:scale-105">
            ...
            <span className="text-3xl font-bold tracking-tight text-white">DeciSmart</span>
          </Link>
        </div>

        {/* Testimonial / Copy */<div className="relative z-10 max-w-lg mt-auto mb-10">
          <blockquote className="space-y-6">
            <p className="text-3xl font-medium text-white leading-snug">
              "DeciSmart has transformed how our team evaluates complex proposals. The structured criteria approach brings clarity we never had before."
            </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="absolute top-8 left-8 lg:hidden flex items-center gap-2">
          ...
          <span className="text-2xl font-bold tracking-tight text-foreground">DeciSmart</span>
        </div>
        ...
        >
          <div className="text-center lg:text-left mb-10">
            <h2 className="text-3xl font-extrabold tracking-tight mb-2 text-foreground">Welcome Back</h2>
